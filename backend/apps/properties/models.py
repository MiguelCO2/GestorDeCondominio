...
class Property(models.Model):
    ...
    monthly_fee = models.DecimalField("Monto mensual (Condominio)", max_digits=10, decimal_places=2, null=True, blank=True)
    rent_fee = models.DecimalField("Monto Alquiler", max_digits=10, decimal_places=2, null=True, blank=True)
