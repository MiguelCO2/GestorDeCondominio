    ...
    <SafeAreaView edges={['top']} style={styles.safe}>
      <ScrollView contentContainerStyle={styles.scroller}>
        <AppBar
          title="Pagos"
          large
          right={!isUnlinkedResident ? <IconBtn icon="download" tone="primary" onPress={handleExport} /> : null}
        />
        ...
        {isUnlinkedResident ? (
          <View style={styles.blockedCard}>
            ...
            <Text style={styles.blockedText}>
              No tienes un apartamento asociado para ver o reportar pagos. Por favor, solicita al administrador la vinculación de tu cuenta.
            </Text>
          </View>
        ) : (
          <>
      ...
      {!isUnlinkedResident && <FAB onPress={handleNewPayment} />}
